        ...
        productsToLoad.forEach((product, index) => {
            ...
            card.innerHTML = `
                <div class="product-image">
                    <img src="${product.imageUrl}" alt="${product[nameKey]}" style="cursor: zoom-in;" onerror="this.onerror=null;this.src='https://placehold.co/300x300/CCCCCC/FFFFFF?text=Image+Not+Found';">
                </div>
